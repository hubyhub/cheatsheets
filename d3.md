...
```javascript
    ...
    svg.selectAll('rect')                       // rect anstelle div
            ...
            .attr('y', function(d){
                return 300 - d*multiplier;      // um die Säulen von unten des SVG-Elements auszurichten: 300 ist höhe des SVG-ELEMENTS, d*multiplier ist Höhe der Säule
            })
            .attr('width', 20)
...
Notitz: **multiplier** dient dazu die Säulen skalieren zu können, um ganzes Feld nutzen zu können. Das ist allerdings nicht die beste Art und Weise. Siehe Kapitel 3.

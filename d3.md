...
Meist handelt es sich um qualitative Merkmale, wie z. B. der in der Frage gesuchte „höchste erreichbare Bildungsabschluss“. Ein weiteres Beispiel sind die Schulnoten: Note 1 ist besser als Note 2, ich habe aber keine Auskunft darüber, ob der Unterschied zwischen Note 1 und 2 gleich groß ist wie der zwischen Note 3 und Note 4.
...
**`rangeBands`: Wenn man ein Diagramm baut, möchte man die Balken auf der x-Achse gleich verteilt haben. Man könnte das manuell berechnen (verfügbarer Platz, Balkenbreite, Paddings,..), oder man verwendet `rangeBand`

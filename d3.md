...
Sie erleichtern das Mapping von der Daten-dimension auf eine visuelle Repräsentation. 
Es gibt unterschiedliche Scales.
...
Scales sind optional, man muß sie nicht verwenden. Nur muß man die Mathematik dahinter dann selber machen.                                                   
...
var yScale = d3.scale.linear()  // SCALE: nimmt einen Wert von einer Input-DOMAIN und mappt ihn auf einen neuen Wert einer Output-RANGE
        .domain([0,25])         // unsere DOMAIN läuft von einem Minimum von 0 bis zu einem Maximum von 25
        .range([0,h]);          // unsere RANGE
